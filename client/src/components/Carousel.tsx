    ...
    return (
        <div className="overflow-hidden relative flex-1">
            ...
            <button type="button" className="text-white absolute top-0 start-0 flex items-center justify-center h-full px-4 group focus:outline-none">
                <svg onClick={imageSlidePrev} className="w-4 h-4 rtl:rotate-180 hover:text-black transition" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 1 1 5l4 4"/></svg>
            ...
            <button type="button" className="text-white absolute top-0 end-0 flex items-center justify-center h-full px-4 group focus:outline-none">
                <svg onClick={imageSlideNext} className="w-4 h-4 rtl:rotate-180 hover:text-black transition" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 9 4-4-4-4"/></svg>
