            ...
            <div id="promote-section" className="snap-start h-screen w-full flex flex-col justify-center">
                <div className="flex flex-col md:flex-row flex-grow items-center">
                    <div className="font-display w-1/2">
                        ...
                        <p className="hidden md:block ml-32 pt-4 text-left text-wrap text-cadus-grey text-1xl">Êtes-vous
                            artiste,
                        ...
                        <p className="hidden md:block ml-32 pt-4 text-left text-wrap text-cadus-grey text-1xl">Votre
                            ...
                            serait précieuse.</p>
                        <p className="md:ml-32 pt-4 text-center md:text-left text-wrap text-cadus-grey text-1xl">Si vous
                            êtes intéressé(e)
            ...
            <div id="donate-section" className="snap-start h-screen w-full flex">
                <div className="flex flex-col md:flex-row-reverse items-center">
                    <div className="font-display w-1/2">
                        ...
                        <p className="text-center md:mr-32 pt-4 md:text-left text-wrap text-cadus-grey text-1xl">Chez
                            Cadus, nous nous
                        ...
                        <p className="hidden md:block mr-32 pt-4 text-left text-wrap text-cadus-grey text-1xl">Votre
                            contribution permet
                            ...
                            besoin.</p>
                        <p className="hidden md:block mr-32 pt-4 text-left text-wrap text-cadus-grey text-1xl">Faites un
                            don aujourd'hui
                    ...
                    <div className="relative w-full mt-40 md:mt-0 md:flex-1 flex justify-center">
                        <div
                            className="bg-cadus-green rounded-r-xl absolute -rotate-3 inset-x-0 top-1/2 transform -translate-y-1/2 -translate-x-16 w-[101%] h-[120%] -z-10"></div>
                        <DonationForm/>
                    </div>
                </div>
            </div>
