...
export default function ScrollIndicator(props: ScrollIndicatorProps) {
    ...
    return (
        <div className="flex justify-center mb-6">
            <a className="animate-bounce border-2 border-transparent text-white rounded-full hover:border-cadus-green hover:text-cadus-green transition" href={targetId}>
